        ...
        _this.routes = [
            {
                ...
                handler: _this.handleLogin,
                localMiddlewares: []
            },
            {
                path: '/register',
                method: AppController_1.Methods.POST,
                handler: _this.handleRegister,
                localMiddlewares: []
            }
        ];
        return _this;
    }
    AuthenticationController.prototype.handleLogin = function (req, res, next) {
        res.json({ message: 'Login Route ' });
    };
    AuthenticationController.prototype.handleRegister = function (req, res, next) {
